...
class TrainsAdmin(admin.ModelAdmin):
    list_display = ('number', 'status', 'from_city', 'to_city',
                    'departure_date', 'arrival_date', )
    list_display_links = ('number',)
    search_fields = ('status', 'from_city', 'to_city',
                     'departure_date', 'arrival_date', )
    list_editable = ('status', 'from_city', 'to_city',
                     'departure_date', 'arrival_date', )
...
class SeatsAdmin(admin.ModelAdmin):
    ...
    search_fields = ('car__number', 'car__train__from_city',
                     'car__train__to_city', 'number', 'status')
