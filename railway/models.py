...
class Trains(models.Model):
    ...
    status = models.CharField('StatusOfTrain', max_length=9, choices=(
        ('NORM', 'normal'), ('CANCELLED', 'cancelled'), ('DIV', 'diverted')), default='normal')
...
class Seats(models.Model):
    ...
    status = models.CharField('SeatStatus', max_length=6, choices=(
        ('FREE', 'free'), ('BOUGHT', 'bought')), default="FREE")
